/*
 * nominal_tracking_augmentedState_REALTIME_types.h
 *
...
#ifndef RTW_HEADER_nominal_tracking_augmentedState_REALTIME_types_h_
#define RTW_HEADER_nominal_tracking_augmentedState_REALTIME_types_h_
#include "rtwtypes.h"
...
typedef struct P_nominal_tracking_augmentedState_REALTIME_T_
  P_nominal_tracking_augmentedState_REALTIME_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_nominal_tracking_augmentedState_REALTIME_T
  RT_MODEL_nominal_tracking_augmentedState_REALTIME_T;

#endif        /* RTW_HEADER_nominal_tracking_augmentedState_REALTIME_types_h_ */
