...
MODEL                := robust_tracking_integral_augmentedState_REALTIME
MODULES              := robust_tracking_integral_augmentedState_REALTIME_data.c robust_tracking_integral_augmentedState_REALTIME_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := robust_tracking_integral_augmentedState_REALTIME.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := robust_tracking_integral_augmentedState_REALTIME_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/REALTIME_v1;Z:/windows_profile/Desktop/REALTIME_v1/robust_tracking_integral_augmentedState_REALTIME_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
