...
MODEL                := nominal_tracking_REALTIME
MODULES              := nominal_tracking_REALTIME_data.c nominal_tracking_REALTIME_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := nominal_tracking_REALTIME.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := nominal_tracking_REALTIME_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/REALTIME_v1;Z:/windows_profile/Desktop/REALTIME_v1/nominal_tracking_REALTIME_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
